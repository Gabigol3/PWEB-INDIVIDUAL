...
// Estoque inicial (total de unidades da edição limitada)
if (!isset($_SESSION['estoque_inicial'])) {
    $_SESSION['estoque_inicial'] = 20;
}

if (!isset($_SESSION['estoque'])) {
    $_SESSION['estoque'] = $_SESSION['estoque_inicial']; // Inicializando o estoque
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['comprar'])) {
    if ($_SESSION['estoque'] > 0) {
        $_SESSION['estoque']--;
        // Padrão Post/Redirect/Get: evita reenvio do formulário ao atualizar a página
...
<body>
  ...
  <section id="sobre" class="hero">
    <div>
      ...
      <p>Edição limitada com apenas <?php echo $_SESSION['estoque_inicial']; ?> unidades. Um item de colecionador para desenvolvedores e fãs da cultura dev.</p>
      <button class="btn" onclick="irParaComprar()">Garanta o Seu Agora</button>
    </div>
    <div>
  ...
  <section class="exclusivo">
    ...
    <button class="btn" onclick="irParaComprar()">Comprar Agora</button>
  </section>
